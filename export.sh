...
if ! command -v discord-chat-exporter &> /dev/null; then
  ...
  # Download the correct ZIP file for Linux (x64)
  curl -LO https://github.com/Tyrrrz/DiscordChatExporter/releases/download/2.44.2/DiscordChatExporter.Cli.linux-x64.zip
